...
Here's a brief description of the 4 (or 5 if you want to timestamp)
powershell varaibles that must be set:  
...
One of the following options must be selected.  Failure to do so will
result in the termination of the program with a non-zero exit status:
